...
#from anm_utils import ANM6Easy
...
print("Total rewards Random", np.sum(reward_adv_vec))
print("Mean rewards Random", np.sum(reward_adv_vec)/200.0)
print("Variance Random", np.sqrt(np.var(reward_adv_vec)))
